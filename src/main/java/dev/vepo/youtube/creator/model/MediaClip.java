...
public class MediaClip {
    ...
    private double startTime; // Start time in the clip (trim start)
    private double endTime; // End time in the clip (trim end)
    private double timelinePosition; // Position on the timeline (in seconds)
    private double duration; // Duration of the clip
